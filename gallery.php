...
<head>
  ...
  <title>TibanyenderaFamily-Gallery page</title>
      ...
      <nav>
        <ul>
          ...
          <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin'] === true): ?>
            <li><a href="admin_approval.php">Admin Panel</a></li>
    ...
    <div class="gallery-container">
      ...
      <div class="section" id="images">
        ...
        <div class="files-grid">
          ...
          listFiles("images", "page_images", 6); ?>
        </div>
      </div>
  ...
  <footer>
    <div class="footer-section">
      <div class="left-footer-section">
        <h2>THE FAMILY OF MR.TIBANYENDERA D.</h2>
        <p>In every conceivable manner, family is a link to our past and a bridge to our future.</p>
      </div>
